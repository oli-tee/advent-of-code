...
def decode_p2_v2(word: str) -> int:
    digit1 = find_first_digit(parse_v2(word))
    digit2 = find_last_digit(parse_v2(word))
    return int(digit1 + digit2)
...
def solve_p2_v2(word_list):
    numbers = [decode_p2_v2(word) for word in word_list]
    return sum(numbers)
